<?php
/**
 * Contains WP_Authress_Api_Change_Email.
 *
 * @package WP-Authress
 *
 * @since 3.9.0
...
/**
 * Class WP_Authress_Api_Change_Email to update a user's email at Authress.
 */
class WP_Authress_Api_Change_Email extends WP_Authress_Api_Abstract {
	...
	/**
	 * WP_Authress_Api_Change_Email constructor.
	 *
	 ...
	 *
	 * @param string|null $user_id - Authress user ID to change the email for.
	...
	public function call( $user_id = null, $email = null ) {
		...
		return $this
			...
			->add_body( 'accessKey', $this->options->get( 'accessKey' ) )
			->patch()
