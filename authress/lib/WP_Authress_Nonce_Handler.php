<?php
/**
 * Contains WP_Authress_Nonce_Handler.
 *
 * @package WP-Authress
 */

/**
 * Class WP_Authress_Nonce_Handler for generating and storing nonce-type values.
 */
class WP_Authress_Nonce_Handler {
	 ...
	 * @var string
	 */
	const NONCE_COOKIE_NAME = 'authress_nonce';
	 ...
	 *
	 * @var WP_Authress_Nonce_Handler|null
	 */
	...
	/**
	 * WP_Authress_Nonce_Handler constructor.
	 ...
	 *
	 * @return WP_Authress_State_Handler|WP_Authress_Nonce_Handler
	 */
	...
	public static function get_storage_cookie_name() {
		return apply_filters( 'authress_nonce_cookie_name', static::NONCE_COOKIE_NAME );
	}
}
